// To parse this data:
//
//   import { Convert, Service } from "./file";
//
//   const service = Convert.toService(json);
//
...
export class Convert {
    public static toService(json: string): Service {
        return cast(JSON.parse(json), r("Service"));
    }

    public static serviceToJson(value: Service): string {
        return JSON.stringify(uncast(value, r("Service")), null, 2);
    }
}
